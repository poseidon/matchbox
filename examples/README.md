...
| [bootkube-install](terraform/bootkube-install) | Install a 3-node Kubernetes v1.8.2 cluster |
...
| bootkube | PXE boot a 3-node Kubernetes v1.8.2 cluster | stable/1520.8.0 | Disk | [tutorial](../Documentation/bootkube.md) |
| bootkube-install | Install a 3-node Kubernetes v1.8.2 cluster | stable/1520.8.0 | Disk | [tutorial](../Documentation/bootkube.md) |
